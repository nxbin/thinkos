...
REPLACE INTO `thinkox_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=6062 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件表' AUTO_INCREMENT=89 ;

REPLACE INTO `thinkox_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
  ...
  (87, 'Rank_checkin', '签到排名', '设置每天某一时刻开始 按时间先后 签到排名，取前十', 1, '{"random":"1","ranktime":null}', '嘉兴想天信息科技有限公司', '0.1', 1408933904, 1),
  ...
  (88, 'Rank_checkin', '签到排名', '设置每天某一时刻开始 按时间先后 签到排名，取前十', 1, '{"random":"1","ranktime":null}', '嘉兴想天信息科技有限公司', '0.1', 1408933904, 1),
...
REPLACE INTO `thinkox_advertising` (`id`, `title`, `type`, `width`, `height`, `status`, `pos`) VALUES
...
REPLACE INTO `thinkox_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
REPLACE INTO `thinkox_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
  (1, 1, 1),
  (1, 1, 2),
  (1, 2, 1),
  (1, 2, 2),
...
REPLACE INTO `thinkox_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
(1, 'admin', 1, '默认组', '', 1, '');
...
REPLACE INTO `thinkox_auth_group_access` (`uid`, `group_id`) VALUES
  (1, 1),
  (1, 3);
...
REPLACE INTO `thinkox_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
REPLACE INTO `thinkox_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`) VALUES
  ...
  (43, 'daw', 'dwa', 42, 0, 10, '', '', '', '', '', '', '', '2', '', 0, 1, 1, 1, 0, '', '', 1406601473, 1406601473, 1, 0);
...
REPLACE INTO `thinkox_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`, `color`, `band_color`, `band_text`) VALUES
...
REPLACE INTO `thinkox_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
  ...
  (13, 'COLOR_STYLE', 4, '后台色系', 1, 'default_color:默认\r\nblue_color:紫罗兰', '后台颜色风格', 1379122533, 1379235904, 1, 'blue_color', 2),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文档模型基础表' AUTO_INCREMENT=14 ;
...
REPLACE INTO `thinkox_event_type` (`id`, `title`, `create_time`, `update_time`, `status`, `allow_post`, `pid`, `sort`) VALUES
...
REPLACE INTO `thinkox_field_group` (`id`, `profile_name`, `status`, `createTime`, `sort`, `visiable`) VALUES
...
CREATE TABLE IF NOT EXISTS `thinkox_follow` (
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='关注表' AUTO_INCREMENT=70 ;
...
REPLACE INTO `thinkox_forum` (`id`, `title`, `create_time`, `post_count`, `status`, `allow_user_group`, `sort`, `logo`) VALUES
  (1, '默认版块', 1407114174, 4, 1, '1', 0, 0);
...
CREATE TABLE IF NOT EXISTS `thinkox_issue_content` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='专辑内容表' AUTO_INCREMENT=25 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_member` (
  ...
  KEY `status` (`status`),
  KEY `name` (`nickname`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会员表' AUTO_INCREMENT=55 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_message` (
  ...
  `status` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='thinkox新增消息表' AUTO_INCREMENT=305 ;
...
REPLACE INTO `thinkox_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
REPLACE INTO `thinkox_seo_rule` (`id`, `title`, `app`, `controller`, `action`, `status`, `seo_keywords`, `seo_description`, `seo_title`, `sort`) VALUES
  (4, '整站标题', '', '', '', 1, '', '', 'ThinkOX', 6),
  (6, '讨论区SEO', 'Forum', 'Index', 'forum', 0, '', '', 'ThinkOX讨论区', 4),
  (7, '微博seo', 'Weibo', 'Index', 'index', 1, '', '1', 'ThinkOX微博', 5),
  (8, '微博详情页SEO', 'Weibo', 'Index', 'weiboDetail', 1, '{$weibo.title|op_t},Thinkox,ox,微博', '{$weibo.content|op_t}', '{$weibo.content|op_t}——ThinkOX微博', 1),
  (9, '用户中心', 'Usercenter', 'Index', 'index', 0, '{$user.nickname|op_t},Thinkox', '{$user.username|op_t}的个人主页', '{$user.nickname|op_t}的个人主页', 2),
...
REPLACE INTO `thinkox_shop_category` (`id`, `title`, `create_time`, `update_time`, `status`, `pid`, `sort`) VALUES
...
REPLACE INTO `thinkox_shop_config` (`id`, `ename`, `cname`, `changetime`) VALUES
...
REPLACE INTO `thinkox_super_links` (`id`, `type`, `title`, `cover_id`, `link`, `level`, `status`, `create_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `thinkox_support` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='支持的表' AUTO_INCREMENT=39 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_talk` (
  ...
  `title` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='会话表' AUTO_INCREMENT=161 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_talk_message` (
  ...
  `talk_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='聊天消息表' AUTO_INCREMENT=255 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_talk_message_push` (
  ...
  `talk_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='状态，0为未提示，1为未点击，-1为已点击' AUTO_INCREMENT=88 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_talk_push` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='对话推送表' AUTO_INCREMENT=95 ;
...
CREATE TABLE IF NOT EXISTS `thinkox_ucenter_member` (
  ...
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户表' AUTO_INCREMENT=55 ;
